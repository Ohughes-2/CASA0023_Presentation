...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-top: -50px;">
  ...
  <div style="flex: 0 0 55%;">
    <h3>- Located in the heart of the Amazon alongside Rio Negro, with a complex network of Igarapés running through the city</h3>
...
<style>
/* This only overrides the variables for this specific slide's panelset */
.panelset {
...
/* Adds a tiny bit of breathing room below the big tabs */
.panel-tabs {
...
<div style="float: left; width: 50%; padding-top: 20px;">
  <img src="Images_Emily/Igrapes_narrow.jpg" style="width: 100%; border-radius: 10px;" />
</div>
]
...
### Stilts dug into the riverbed/banks
<div style="text-align: center; font-size: 2.5em; margin: -10px 0;">
...
<div style="text-align: center; font-size: 2.5em;">&darr;</div>
...
#### - Stop people settling in dangerous areas before it is politically difficult to remove them
...
#### - Reduce prevelance of waterborn diseases

### 2. Environmental Preservation
#### - Protect ecological corridors (rivers & grapés)
